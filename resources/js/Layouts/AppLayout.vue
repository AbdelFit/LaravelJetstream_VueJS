        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('courses')" :active="$page.currentRouteName == 'courses'">
                                Formations
                            </jet-nav-link>

                            <jet-nav-link :href="route('userCourses')" :active="$page.currentRouteName == 'userCourses'">
                                Mes formations
                            </jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <jet-responsive-nav-link :href="route('courses')" :active="$page.currentRouteName == 'courses'">
                        Formations
                    </jet-responsive-nav-link>

                    <jet-responsive-nav-link :href="route('userCourses')" :active="$page.currentRouteName == 'userCourses'">
                        Formations
                    </jet-responsive-nav-link>
                </div>
